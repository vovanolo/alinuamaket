              ...
              <div className="col">
                <div className="switch">
                  ...
                  <div className="switch__box">
                    ...
                    <Field name="locationFrom" type="text" className="switch__input" placeholder={t('Вкажіть локацію')} />
                    <sub className="switch__sub-title text_grey">{t('місто, область, країна')}</sub>
                  </div>

                  <div className="switch__box">
                    <p className="switch__title text_grey">{t('до')}</p>
                    <Field name="locationTo" type="text" className="switch__input" placeholder={t('Вкажіть локацію')} />
                    <sub className="switch__sub-title text_grey">{t('місто, область, країна')}</sub>
                  </div>
                </div>
              </div>
                ...
                <div className="switch">
                  ...
                  <div className="switch__box">
                    ...
                    <div className="switch__input-container">
                      <Field name="receiveDate" type="date" className="switch__input" />
                      <Field name="receiveTime" type="time" className="switch__input" />
                    </div>
                    <sub className="switch__sub-title text_grey">{t('місто, область, країна')}</sub>
                  </div>
                  ...
                  <div className="switch__box">
                    ...
                    <div className="switch__input-container">
                      <Field name="returnDate" type="date" className="switch__input" />
                      <Field name="returnTime" type="time" className="switch__input" />
                    </div>
                    <sub className="switch__sub-title text_grey">{t('місто, область, країна')}</sub>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col">
                <div className="row row-cols-md-2 row-cols-1">
                  <Field as={Option} name="extras" value="Charger" id={1} text={t('Зарядне/тримач для тел 5€ /Доба')} />
                  <Field as={Option} name="extras" value="Baby chair" id={2} text={t('Дитяче крісло 5€ /Доба')} />
                  <Field as={Option} name="extras" value="Additional driver" id={3} text={t('Додатковий водій 10€ /Одноразово')} />
                  <Field as={Option} name="extras" value="GPS" id={4} text={t('GPS навігація 5€ /Доба')} />
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col">
                <div className="form-row mb-3">
                  <div className="col">
                    <Field name="name" className="input" type="text" placeholder={t('Ваше ім\'я')} />
                  </div>
                </div>

                <div className="form-row mb-3">
                  <div className="col">
                    <Field name="phone" className="input" type="tel" placeholder={t('Телефон')} />
                  </div>
                  <div className="col">
                ...
                <div className="form-row mb-3">
                  <div className="col">
                    <Field name="comment" as="textarea" className="input" placeholder={t('Коментар')} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4">
              ...
              <div className="row">
                <div className="col">
                  <label className="reserv__agreement-label">
                    ...
                    <Field name="agreeWithTerms" className="reserv__agreement-checkbox" type="checkbox" />
                  </label>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-md-10">
                  <button type="submit" className="btn_main">{t('Орендувати')}</button>
                </div>
              </div>
            </div>
          </div>

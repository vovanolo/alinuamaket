...
const resources = {
  ua: {
    translation: {
      ...
      'Додаткові опції': 'Додаткові послуги',
      Блог: 'Блог',
      ...
      'Виберіть клас автомобіля': 'Заповніть форму та відправте запит',
      Трансфер: 'Трансфер',
      Погодинно: 'Погодинно',
      Дата: 'Дата',
      Час: 'Час',
      ...
      'Клас авто': 'Клас авто',
      'Ознайомитись з умовами прокату': 'Ознайомитись з умовами прокату',
      ...
      'Аудіо-система': 'Аудіо-система',
      Сигналізація: 'Сигналізація',
      Колір: 'Колір',
      'Ціна авто': 'Ціна авто',
      Завдаток: 'Завдаток',
      'Повна вартість оренди': 'Повна вартість оренди',
      'Оплата вартості авто': 'Оплата вартості авто',
      'Вартість оренди з правом викупу': 'Вартість оренди з правом викупу',
      'Повна вартість': 'Повна вартість',
    },
  },
  ru: {
    translation: {
      ...
      'Додаткові опції': 'Дополнительные услуги',
      Блог: 'Блог',
      ...
      'Клас авто': 'Класс машин',
      'Ознайомитись з умовами прокату': 'Ознакомиться с условиями проката',
      ...
      'Аудіо-система': 'Аудио-система',
      Сигналізація: 'Сигнализация',
      Колір: 'Цвет',
      'Ціна авто': 'Цена машины',
      Завдаток: 'Залог',
      'Повна вартість оренди': 'Полная стоимость аренды',
      'Оплата вартості авто': 'Оплата стоимости машины',
      'Вартість оренди з правом викупу': 'Стоимость аренды с правом выкупа',
      'Повна вартість': 'Полная стоимость',
    },
  },
  en: {
    translation: {
      ...
      'Умови оренди': 'Terms and conditions',
      'Часті запитання': 'Often questions',
      'Політика конфіденційності': 'Privacy policy',
      'Додаткові опції': 'Additional services',
      Блог: 'Blog',
      ...
      'Виберіть дату та час':
        'Select the date, time and pick-up/return address of the car',
      ...
      'Sim-карта': 'Sim card',
      'вул. Любінська 196': '196 Lyubinska str.',
      'Аеропорт Бориспіль': 'Boryspil Airport',
      'вул. Є. Коновальця 264А': '264А Konovaltsya str.',
      'вул. Академіка Павлова 20Б': '20B Academic Pavlov str.',
      'Клас авто': 'Class auto',
      'Ознайомитись з умовами прокату': 'Read the rental conditions',
      'Рік випуску': 'Year',
      Привід: 'Drive',
      Пробіг: 'Mileage',
      Двигун: 'Engine',
      Трансмісія: 'Transmission',
      Кондиціонер: 'Air conditioning',
      'Аудіо-система': 'Audio system',
      Сигналізація: 'Car alarm system',
      Колір: 'Colour',
      'Ціна авто': 'Car price',
      Завдаток: 'Deposit',
      'Повна вартість оренди': 'Full rental price',
      'Оплата вартості авто': 'Payment of the cost of car',
      'Вартість оренди з правом викупу': 'Rent price with option to purchase',
      'Повна вартість': 'Full cost',
    },
  },
  pl: {
    translation: {
      Прокат: 'Wypożyczalnia',
      Трансфери: 'Transfery',
      Асистенс: 'Wsparcie',
      Контакти: 'Kontakty',
      ...
      "Зв'язок": 'Kontakt',
      Послуги: 'Usługi',
      Автовикуп: 'Auto odkupienie',
      'Про компанію': 'O firmie',
      'Програма лояльності': 'Program lojalnościowy',
      'Про нас': 'O nas',
      'Прокат авто': 'Wypożyczalnia samochodów',
      'Умови оренди': 'Warunki najmu',
      'Часті запитання': 'Często Zadawane Pytania',
      'Політика конфіденційності': 'Polityka prywatności',
      'Додаткові опції': 'Dodatkowe usługi',
      Блог: 'Blog',
      'Заповніть форму': 'Fill in the form',
      'Вкажіть імя': 'Imię',
      'Вкажіть email': 'Email',
      'Вкажіть телефон': 'Telefon',
      Відправити: 'Wysłać',
      Відправлено: 'Wysłano',
      'Оренда авто в Україні': 'Rent cars in Ukraine',
      Львів: 'Lwów',
      Тернопіль: 'Ternopil',
      'Івано-Франківськ': ' Iwano-Frankowsk',
      Харків: 'Charków',
      Київ: 'Kijowie',
      від: 'Odbiór',
      до: 'Zwrot',
      'Вкажіть локацію': 'Określ lokalizację',
      'місто, область, країна': 'miasto, region, kraj',
      Отримання: 'Wybierz datę',
      Повернення: 'Wybierz datę',
      'Як це працює?': 'Jak to pracuje?',
      'Бронювати авто легше ніж ви думаєте':
        'Rezerwacja samochodu jest łatwiejsza niż myślisz',
      'Оберіть локацію': 'Wybierz lokalizację',
      'Оберіть дату': 'Wybierz datę',
      'Бронюйте своє авто': 'Zarezerwuj samochód',
      'Вкажіть зручне для вас місце розташування':
        'Określ dogodną lokalizację dla Ciebie',
      'Визначіть зручний для вас час отримання авто':
        'Określ czas wygodny, aby otrzymać samochód',
      'Залишилось обрати автомобіль який ви отримаєте':
        'Pozostaje wybrać samochód, który otrzymasz',
      'Орендуй на довгий термін, та отримуй за кожні 10 днів прокату по 5% знижки на наступну оренду ( *знижка накопичувальна)':
        'Rent for a long term, and get a 5% discount on the next rent (* cumulative discount) for every 10 days of rental',
      'Залиш відгук з фотографією про компанію ALIN на нашій сторінці в Instagram або на Google Maps та отримай додатково 5% знижки на наступну оренду':
        'Leave a review with a photo of ALIN on our Instagram page or on Google Maps and get an additional 5% discount on the next rental',
      ...
      'При оренді автомобіля, клієнти компанї отримають знижки на проживання в ряді готелей (перелік готелів-партнерів уточнюйте в менеджера)':
        'When renting a car, the company customers will receive discounts on accommodation in a number of hotels (check the list of partner hotels with the manager)',
      'Максимально сумарна знижка 30%': 'Maximum total discount 30%',
      'Партнери компанії': 'Partnerzy firmy',
      Вибір: 'Wybór',
      Бронювання: 'Rezerwować',
      'Сортувати за': 'Sortuj według',
      'За зростанням ціни': 'Cena (wysoka-niska)',
      'За спаданням ціни': 'Cena (niska-wysoka)',
      'Бронювання автомобіля': 'Rezerwacja samochodu',
      'Налаштування бронювання': 'Ustawienia rezerwacji',
      'Зарядне/тримач для тел': 'Ładowarka / uchwyt na telefon',
      Доба: 'dzień',
      'Додатковий водій': 'Dodatkowy kierowca',
      Одноразово: 'jednorazowo',
      Завдаток: 'Kaucja',
      'Без завдатку': 'Bez depozytu',
      'З завдатком': 'Z kaucją',
      'Особисті дані': 'Dane osobiste',
      Коментар: 'Komentarz',
      'В вартість оренди включено': 'Cena wynajmu obejmuje:',
      'Ціна оренди': 'Cena wynajmu',
      'Я погоджуюсь з умовами прокату': 'Zgadzam się z warunkami wynajmu',
      'Заявка успішно відправлена': 'Application successfully submitted',
      'Дякуємо за замовлення': 'Thank you for your order',
      'Інформація про замовлення': 'Order information',
      'Автомобіль:': 'Car:',
      ...
      Телефон: 'Phone',
      'На головну': 'Back home',
      'Послуга «Alin Assistance»': 'Alin Pomoc serwisowa',
      'Багато справ, безліч дзвінків, важливі зустрічі, серйозні переговори? У величезному списку буденних справ, зовсім нема часу для свого чотирьох колісного залізного друга? Адже теж потребує уваги. Ми прагнемо аби ваше життя було комфортним, аби ви мали можливість займатись улюбленими справами, саме тому ми розробили унікальну програму з обслуговування клієнтів - персональний сервіс консультант Alin Assistance.':
        'Wiele spraw, wiele telefonów, ważne spotkania, poważne negocjacje? Na ogromnej liście rzeczy  do zrobienia nie masz czasu dla swojego czterokołowego żelaznego przyjaciela? W końcu wymaga też uwagi. Chcemy, aby Twoje życie było wygodne, dzięki czemu masz możliwość zrobić  swoje ulubione rzeczy, dlatego stworzyliśmy  unikalny program obsługi klienta - osobisty  konsultant Alin usługa Assistance.',
      'Що входить?': 'Co jest wliczone?',
      'Особливі послуги': 'Usługi specjalne',
      'Запис авто на ремонт чи проведення техобслуговування':
        'Rejestracja samochodu do naprawy lub konserwacji',
      'Підбір автозапчастин відповідно до Ваших побажань (б/в, нові)':
        'Dobór części samochodowych według życzenia (używane, nowe)',
      'Страхування авто': 'Ubezpieczenie samochodu',
      'Оформлення полісу цивільної відповідальності':
        'Rejestracja polisy odpowiedzialności cywilnej',
      'Замовлення евакуатора': 'Zamówienie lawety',
      'Продаж автомобіля': 'Sprzedaż samochodów',
      'Основний принцип роботи компанії – не просто обслуговування автомобілів, а результат та вдячні постійні клієнти! Саме завдяки їй ви зможете зекономити свій час та нерви. Забудьте про безмежні черги та століття втраченого часу.':
        'Główną zasadą działania firmy jest nie tylko serwis samochodowy, ale efekt i wdzięczni stali klienci! Dzięki niej zaoszczędzisz czas i nerwy. Zapomnij o niekończących się kolejkach i wieki straconego czasu.',
      'Програма надає вам можливість вирішити всі технічні питання не виходячи з дому чи офісу. Лише один дзвінок і ось персональний сервіс консультант вирушає вам на допомогу.':
        'Program daje możliwość, aby rozwiązać wszystkie problemy techniczne bez wychodzenia z domu lub biura. Wystarczy jeden telefon, a osobisty konsultant przyjdzie Ci z pomocą.',
      'Оренда машини з водієм': 'Wynajem samochodu z kierowcą',
      'Виберіть трансфер або погодинну поїздку':
        'Wybierz typ transferu z poniższych opcji',
      'Виберіть дату та час':
        'Wybierz datę, godzinę i adres adres dostawy/zwrotu samochodu',
      'Виберіть клас автомобіля': 'Wypełnij formularz i wyślij zapytanie',
      Трансфер: 'Transfer',
      Погодинно: 'Hourly',
      Дата: 'Data',
      Час: 'Godzina',
      Далі: 'Next',
      'Є запитання?': 'Mam pytanie?',
      "Зв'язатись з нами": 'Skontaktuj się z nami',
      Надіслати: 'Wysłać',
      'Автопрокат у Львові від компанії ALIN':
        'Wypożyczalnia samochodów we Lwowie od firmy ALIN',
      'Компанія з 2016 року надає послуги з прокату автомобілів без водія. Автопарк компанії у Львові – це сучасні автомобілі, оснащення яких, задовольнить смаки і переваги клієнта. Щоб показати серйозність намірів в бізнесі, часто необхідно підкреслити високий статус перед партнерами. У цьому допоможе оренда у Львові авто преміум або бізнес-класу. Для клієнтів, які не готові платити за статусні автомобілі, компанія надасть автотранспорт середнього або економ-класу. У компанії Alin є раннє бронювання автомобілів марок- VW, Mitsubishi, Subaru, Suzuki, Ford, Peugeot, Renault, Dacia. Транспорт пройшов техогляд, згідно з вимогами українського законодавства. Орендовані машини застраховані від поломки, нещасних випадків водія та пасажирів.':
        "Since 2016, the company has been providing car rental services without a driver. The company's fleet in Lviv is modern cars, the equipment of which will satisfy the tastes and preferences of the client. To show the seriousness of intentions in business, it is often necessary to emphasize the high status of partners. Renting a premium or business class car in Lviv will help. For customers who are not willing to pay for status cars, the company will provide middle or economy class vehicles. Alin has early booking of cars of brands: VW, Mitsubishi, Subaru, Suzuki, Ford, Peugeot, Renault, Dacia. The vehicle was inspected in accordance with the requirements of Ukrainian legislation. Leased cars are insured against breakdowns, accidents of the driver and passengers. ",
      'При оренді автомобілів в ALIN кожен клієнт оцінить переваги':
        'When renting a car in ALIN, each customer will appreciate the benefits:',
      ...
      'і дізнайтеся деталі!': 'And find out the details!',
      'Для замовлення автовикупу звяжіться з нами за телефоном':
        'Aby uzyskać szczegółowe informacje, skontaktuj się z menedżerem',
      'Дякуємо за заявку': 'Thank you for your request',
      Закрити: 'Close',
      'Залиште свій номер і ми вам зателефонуємо!':
        'Zostaw swój numer a oddzwonimy!',
      'Get a price': 'Get a price',
      'дата та час': 'Data i godzina',
      day: 'dzień',
      days: 'dni',
      Summary: 'Rezultat',
      'GPS навігація': 'Nawigacja GPS',
      'Дитяче крісло': 'Fotelik samochodowy dla dziecka',
      'Антибукс зимовий': 'Antibuks zima',
      Електросамокат: 'Skuter elektryczny',
      'Wi-Fi роутер': 'Router Wi-Fi',
      'Sim-карта': 'Karta SIM',
      'вул. Любінська 196': '196 Lyubinska str.',
      'Аеропорт Бориспіль': 'Boryspil Airport',
      'вул. Є. Коновальця 264А': '264А Konovaltsya str.',
      'вул. Академіка Павлова 20Б': '20B Academic Pavlov str.',
      'Клас авто': 'Class auto',
      'Ознайомитись з умовами прокату': 'Zapoznaj się z warunkami wynajmu',
      'Рік випуску': 'Rok produkcji',
      Привід: 'Napęd',
      Пробіг: 'Przebieg',
      Двигун: 'Pojemność skokowa',
      Трансмісія: 'Skrzynia biegów',
      Кондиціонер: 'Klimatyzacja',
      'Аудіо-система': 'Audiosystema',
      Сигналізація: 'Sygnalizacja',
      Колір: 'Kolor',
      'Ціна авто': 'Cena samochodu',
      Завдаток: 'Kaucja',
      'Повна вартість оренди': 'Pełna cena wynajmu',
      'Оплата вартості авто': 'Zapłata ceny samochodu',
      'Вартість оренди з правом викупу': 'Koszt wynajmu z prawem do wykupu',
      'Повна вартість': 'Total',
    },
  },
};
